...
function showUndoPopup(
  ...
  const updateMessage = () => {
    popup!.innerHTML = `${message} (${timeLeft}s) <button id="undo-btn" aria-label="Cancelar eliminación de cuenta">Deshacer</button>`;
  ...
  popup.className = "popup-message popup-undo popup-show";
  updateMessage();
